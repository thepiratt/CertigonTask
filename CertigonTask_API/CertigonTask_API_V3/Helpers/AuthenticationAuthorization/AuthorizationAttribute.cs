...
namespace CertigonTask_API_V3.Helpers.AuthenticationAuthorization
{
    ...
    {
        public AuthorizationAttribute(bool admin, bool manager)
    ...
    public class MyAuthorizeImpl : IActionFilter
    {
        ...
        public void OnActionExecuting(ActionExecutingContext filterContext)
        {
            ...
            if (filterContext.HttpContext.GetLoginInfo().isPermissionAdmin)
            {
                return;//ok - ima pravo pristupa
            }

            if (filterContext.HttpContext.GetLoginInfo().isPermissionManager)
            {
                return;//ok - ima pravo pristupa
            }
